...
For the new textbook elements, pretend like you're using basic HTML! Make sure there is an empty line between the tags and the actual content; without them, these components won't work!

<Warning>

The Warning tag. Use the `html›<Warning>` tag to use this.

</Warning>

<OtherInfo>

The Other Information tag. Use the `html›<OtherInfo>` tag to use this.

</OtherInfo>

<TipBox>

The Tip Box tag. Use the `html›<TipBox>` tag to use this.

</TipBox>

<DirectorBox>

The Do It In Director tag. Use the `html›<DirectorBox>` tag to use this.
